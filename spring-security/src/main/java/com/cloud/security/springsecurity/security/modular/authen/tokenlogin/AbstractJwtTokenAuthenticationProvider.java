...
public abstract class AbstractJwtTokenAuthenticationProvider implements
    ...
    private UserDetailsChecker preAuthenticationChecks = new AbstractJwtTokenAuthenticationProvider.DefaultPreAuthenticationChecks();
    private UserDetailsChecker postAuthenticationChecks = new AbstractJwtTokenAuthenticationProvider.DefaultPostAuthenticationChecks();
     ...
     * <code>JwtTokenAuthenticationToken</code>, these should also appear in this
     * method.
     *
     * @param userDetails as retrieved from the
     * {@link #retrieveUser(String, JwtAuthenticationToken)} or
     * <code>UserCache</code>
     ...
     * {@link #additionalAuthenticationChecks(UserDetails, JwtAuthenticationToken)}
